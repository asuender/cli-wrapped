...
import type { HourlyChartProps } from "../types.js";
...
export default function HourlyChart(props: HourlyChartProps) {
  const { hourlyBreakdown, peakHour, peakHourCount } = props;
  ...
  // Normalize values to total height (CHART_HEIGHT rows x 8 levels per row)
